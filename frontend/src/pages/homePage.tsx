...
const HomePage: React.FC = () => {
  ...
  const handleOrderAdded = (newOrder: Order) => {
    ...
    showNotification(`Order for ${newOrder.customerName} added!`, 'success');
  };
  ...
  return (
    <div className="container">
      ...
      <div className="grid">
        ...
        <div className="card">
          <OrderTracker orders={orders} onOrderDeleted={handleOrderDeleted} onOrderUpdated={handleOrderUpdated} />
        </div>
        <div className="card">
          <SearchOrders />
        </div>
